...
class MultiTaskModel(nn.Module,MainTask):
    def __init__(self,in_channel=12,classes_list=[1,4]):
        super(MultiTaskModel, self).__init__()
        c1,c3 = classes_list
        self.c1,self.c3 = c1,c3 
    ...
    def keras_filter(self):
        ...
        # print("dict_x\n",len(dict_x))
        # print("dict",dict_x)
        ordered_name = [k for k,v in dict_x.items() if ( "classifer_att3" not in k and "classifer_att4" not in k )] 
        # print(ordered_name)
        return ordered_name 
