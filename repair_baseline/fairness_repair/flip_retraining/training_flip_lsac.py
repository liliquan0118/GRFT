...
for benchmark in ['g','r','r&g']:
    ...
    constraint = pre_lsac.constraint
    ...
    history = model.fit(X_shuffled, y_shuffled, epochs=30, validation_data=(pre_lsac.X_val, pre_lsac.y_val))
    model.evaluate(pre_lsac.X_test, pre_lsac.y_test) # 84.32% accuracy
    model.save("models/models_flip/lsac_model_"+benchmark+".h5")
    # The precision rate is  0.7338425381903643 , the recall rate is  0.5454148471615721 , and the F1 score is  0.625751503006012
    # loss: 0.4502 - accuracy: 0.8541