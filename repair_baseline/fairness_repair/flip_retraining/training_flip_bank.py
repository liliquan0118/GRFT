...
for benchmark in ['a']:
    ...
    X_train = pre_bank_marketing.X_train
    y_train = pre_bank_marketing.y_train
    ...
    history = model.fit(X_shuffled, y_shuffled, epochs=30, validation_data=(pre_bank_marketing.X_val, pre_bank_marketing.y_val))
    model.evaluate(pre_bank_marketing.X_test, pre_bank_marketing.y_test) # 84.32% accuracy
    model.save("models/models_flip/bank_model_"+benchmark+".h5")
    # The precision rate is  0.7338425381903643 , the recall rate is  0.5454148471615721 , and the F1 score is  0.625751503006012
    # loss: 0.2876 - accuracy: 0.8914