...
for benchmark in ['r&g']:
    ...
    X_train = pre_census_income.X_train
    y_train = pre_census_income.y_train
    ...
    history = model.fit(X_shuffled, y_shuffled, epochs=30, validation_data=(pre_census_income.X_val, pre_census_income.y_val))
    model.evaluate(pre_census_income.X_test, pre_census_income.y_test) # 84.32% accuracy
    model.save("models/models_flip/adult_model_"+benchmark+".h5")
