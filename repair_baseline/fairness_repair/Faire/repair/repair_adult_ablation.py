...
if __name__ == '__main__':
    ...
    parser.add_argument('--income_path', default='models/models_from_tests/adult_model.h5', help='model_path')
    ...
    data_name = f"discriminatory_data/C-{args.attr}_ids_EIDIG_INF_1.npy"
