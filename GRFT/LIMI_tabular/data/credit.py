...
def credit_data(
    path='/data/c/liliquan/fairness_testing/Latent_Imitator/LIMI_tabular/my_credit_train.csv',
):
    """
    ...
    X=pre_german_credit.X
    Y=pre_german_credit.y
...
def credit_predict_data(
    paths=["/data/c/liliquan/fairness_testing/Latent_Imitator/LIMI_tabular/exp/table/credit/sampled_data.csv"],
):
    X = []
