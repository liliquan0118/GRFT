...
# for model_dir in ${root}train_dnn/models_flip/lsac*; do
#     if [ -d "$model_dir" ]; then
...
for model_dir in ${root}train_dnn/models_adv/lsac_model_0.8*; do
    if [ -d "$model_dir" ]; then
        label_file="${model_dir}/labels.npy"
        score_file="${model_dir}/predict_scores.npy"
...
# for model_dir in ${root}train_dnn/multitask_models/lsac*; do
#     if [ -d "$model_dir" ]; then
#         label_file="${model_dir}/labels.npy"
#         score_file="${model_dir}/predict_scores.npy"
...
# for model_dir in ${root}train_dnn/retrained_models/lsac_EIDIG_INF_retrained_model*; do
#     if [ -d "$model_dir" ]; then
#         label_file="${model_dir}/labels.npy"
#         score_file="${model_dir}/predict_scores.npy"
...
# for model_dir in ${root}train_dnn/train/lsac*; do
#     if [ -d "$model_dir" ]; then
#         label_file="${model_dir}/labels.npy"
#         score_file="${model_dir}/predict_scores.npy"
...
# for model_dir in ${root}train_dnn/gated_models/lsac*; do
#     if [ -d "$model_dir" ]; then
#         label_file="${model_dir}/labels.npy"
#         score_file="${model_dir}/predict_scores.npy"
...
#  --exp_name='lsac' \
#  --latent_file=$root'table/lsac/sampled_latent.pkl' \
#  --label_file=$root'train_dnn/train/lsac_base/labels.npy' \
#  --score_file=$root'train_dnn/train/lsac_base/predict_scores.npy' \
#  --train_num=50000
