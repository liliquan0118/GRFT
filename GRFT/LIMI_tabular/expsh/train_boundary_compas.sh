...
# for model_dir in ${root}train_dnn/models_flip/compas*; do
#     if [ -d "$model_dir" ]; then
...
# for model_dir in ${root}train_dnn/models_adv/compas*; do
#     if [ -d "$model_dir" ]; then
#         label_file="${model_dir}/labels.npy"
#         score_file="${model_dir}/predict_scores.npy"
...
# for model_dir in ${root}train_dnn/multitask_models/compas*; do
#     if [ -d "$model_dir" ]; then
#         label_file="${model_dir}/labels.npy"
#         score_file="${model_dir}/predict_scores.npy"
...
# for model_dir in ${root}train_dnn/retrained_models/compas*; do
#     if [ -d "$model_dir" ]; then
#         label_file="${model_dir}/labels.npy"
#         score_file="${model_dir}/predict_scores.npy"
...
# for model_dir in ${root}train_dnn/train/compas*; do
#     if [ -d "$model_dir" ]; then
#         label_file="${model_dir}/labels.npy"
#         score_file="${model_dir}/predict_scores.npy"
...
for model_dir in ${root}train_dnn/gated_models/compas*; do
    if [ -d "$model_dir" ]; then
        label_file="${model_dir}/labels.npy"
        score_file="${model_dir}/predict_scores.npy"
...
#  --exp_name='compas' \
#  --latent_file=$root'table/compas/sampled_latent.pkl' \
#  --label_file=$root'train_dnn/train/compas_base/labels.npy' \
#  --score_file=$root'train_dnn/train/compas_base/predict_scores.npy' \
#  --train_num=50000
