...
# for model_dir in ${root}train_dnn/models_flip/bank*; do
#     if [ -d "$model_dir" ]; then
...
for model_dir in ${root}train_dnn/models_adv/bank_model_0.5*; do
    if [ -d "$model_dir" ]; then
        label_file="${model_dir}/labels.npy"
        score_file="${model_dir}/predict_scores.npy"
...
# for model_dir in ${root}train_dnn/multitask_models/bank*; do
#     if [ -d "$model_dir" ]; then
#         label_file="${model_dir}/labels.npy"
#         score_file="${model_dir}/predict_scores.npy"
...
# for model_dir in ${root}train_dnn/retrained_models/bank*; do
#     if [ -d "$model_dir" ]; then
#         label_file="${model_dir}/labels.npy"
#         score_file="${model_dir}/predict_scores.npy"
...
# for model_dir in ${root}train_dnn/train/bank*; do
#     if [ -d "$model_dir" ]; then
#         label_file="${model_dir}/labels.npy"
#         score_file="${model_dir}/predict_scores.npy"
...
# for model_dir in ${root}train_dnn/gated_models/bank*; do
#     if [ -d "$model_dir" ]; then
#         label_file="${model_dir}/labels.npy"
#         score_file="${model_dir}/predict_scores.npy"
