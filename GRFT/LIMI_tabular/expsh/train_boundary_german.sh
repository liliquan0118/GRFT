...
# for model_dir in ${root}train_dnn/models_flip/german*; do
#     if [ -d "$model_dir" ]; then
...
for model_dir in ${root}train_dnn/models_adv/german_model_0.95*; do
    if [ -d "$model_dir" ]; then
        label_file="${model_dir}/labels.npy"
        score_file="${model_dir}/predict_scores.npy"
...
# for model_dir in ${root}train_dnn/multitask_models/german*; do
#     if [ -d "$model_dir" ]; then
#         label_file="${model_dir}/labels.npy"
#         score_file="${model_dir}/predict_scores.npy"
...
# for model_dir in ${root}train_dnn/retrained_models/german*; do
#     if [ -d "$model_dir" ]; then
#         label_file="${model_dir}/labels.npy"
#         score_file="${model_dir}/predict_scores.npy"
...
# for model_dir in ${root}train_dnn/train/german*; do
#     if [ -d "$model_dir" ]; then
#         label_file="${model_dir}/labels.npy"
#         score_file="${model_dir}/predict_scores.npy"
...
# for model_dir in ${root}train_dnn/gated_models/german*; do
#     if [ -d "$model_dir" ]; then
#         label_file="${model_dir}/labels.npy"
#         score_file="${model_dir}/predict_scores.npy"
