...
# --dataset_path=$root'table/credit/sampled_data.csv' \
# --model_path=$root'train_dnn/models_adv/german_model_g.h5' \
# --output_path=$root'train_dnn/models_adv/german_model_g/predict_scores.npy' \
# --output_path2=$root'train_dnn/models_adv/german_model_g/labels.npy' \
# 2>&1 | tee '../exp/train_dnn/models_adv/german_model_g/predict.log'   & 
...
CUDA_VISIBLE_DEVICES=2 python model_predict.py --dataset=lsac \
--dataset_path=$root'table/lsac/sampled_data.csv' \
--model_path=$root'train_dnn/models_adv/lsac_model_0.8_r&g.h5' \
--output_path=$root'train_dnn/models_adv/lsac_model_0.8_r&g/predict_scores.npy' \
--output_path2=$root'train_dnn/models_adv/lsac_model_0.8_r&g/labels.npy' \
2>&1 | tee '../exp/train_dnn/models_adv/lsac_model__0.8r&g/predict.log'   & 