...
--model_path=$root'train_dnn/models_adv/bank_model_0.5.h5' \
--output_path=$root'train_dnn/models_adv/bank_model_0.5/predict_scores.npy' \
--output_path2=$root'train_dnn/models_adv/bank_model_0.5/labels.npy' \
2>&1 | tee ../exp/train_dnn/models_adv/bank_model_0.5/predict.log
