...
for benchmark in ['a']:
    ...
    constraints = pre_bank_marketing.constraint
    ...
    # 评估模型
    results = model.evaluate(pre_bank_marketing.X_test, pre_bank_marketing.y_test)
    print("Test loss, Test accuracy:", results)

    # 保存模型
    model.save("models/models_lcds/bank_model_"+benchmark+".h5")