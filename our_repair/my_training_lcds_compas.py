...
# ('compas-r', [4]), ('compas-g', [5]), ('compas-r&g', [4,5])
    pos_map = { 'r': [4],
                'g': [5],
                'r&g': [4,5]
                }
    ...
    constraints = pre_compas_scores.constraint
    ...
    # 评估模型
    results = model.evaluate(pre_compas_scores.X_test, pre_compas_scores.y_test)
    print("Test loss, Test accuracy:", results)

    # 保存模型
    model.save("models/models_lcds/compas_model_"+benchmark+".h5")
