...
for benchmark in ['a','g','r','a&g','a&r','r&g']:
    ...
    constraints = pre_census_income.constraint
    ...
    # 评估模型
    results = model.evaluate(pre_census_income.X_test, pre_census_income.y_test)
    print("Test loss, Test accuracy:", results)

    # 保存模型
    model.save("models/models_lcds/adult_model_"+benchmark+".h5")
