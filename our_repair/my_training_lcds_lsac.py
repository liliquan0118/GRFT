...
for benchmark in ['g','r','r&g']:
    ...
    # [('lsac-r', [10]), ('lsac-g', [9]), ('lsac-r&g', [10,9])]
    pos_map = { 'r': [10],
                'g': [9],
                'r&g': [10,9]
                }
    ...
    constraints = pre_lsac.constraint
    ...
    # 评估模型
    results = model.evaluate(pre_lsac.X_test, pre_lsac.y_test)
    print("Test loss, Test accuracy:", results)

    # 保存模型
    model.save("models/models_lcds/lsac_model_"+benchmark+".h5")
